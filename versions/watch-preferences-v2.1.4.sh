...
#  $11 = SCRIPT_OUTPUT_DIR — dossier de sortie des scripts (défaut: /Users/Shared/watch-preferences-scripts)
...
SCRIPT_OUTPUT_DIR="${argv[11]:-/Users/Shared/watch-preferences-scripts}"
...
if [ "$SCRIPT_OUTPUT" = "true" ]; then
  /bin/mkdir -p "$SCRIPT_OUTPUT_DIR" 2>/dev/null || SCRIPT_OUTPUT_DIR="/Users/Shared/watch-preferences-scripts-${$}"
