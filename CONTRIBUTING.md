...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/Watch-preferences.git
...
- Check existing [Issues](https://github.com/ORIGINAL_OWNER/Watch-preferences/issues)
- Review [Discussions](https://github.com/ORIGINAL_OWNER/Watch-preferences/discussions)
